...
/*
void parseExpression(const QString& expr, QStack<Token>& stack, QVector<double>& values) {
    // Очищаем стек и массив значений
    stack.clear();
    values.clear();
    ...
    // Создаем объекты токенов и помещаем их в стек
    foreach (QString token, tokens) {
        ...
        // Создаем объект токена и помещаем его в стек
        Token tokenObj(type, value);
        tokenObj.precedence = precedence;
        stack.push(tokenObj);
    }
}*/
